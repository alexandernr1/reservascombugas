...
public final class LoguinDeAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtusuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, 160, 30));
        ...
        jPanel1.add(txtpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 260, 160, 30));

        passwordLabel.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        passwordLabel.setText("Password:");
        jPanel1.add(passwordLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, -1, -1));

        usuarioLabel.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        usuarioLabel.setText("Usuario:");
        jPanel1.add(usuarioLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, -1, -1));
